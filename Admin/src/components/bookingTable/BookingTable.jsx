...
const BookingList = () => {
  ...
  const { data, loading, error } = useFetch(`/booking/get`);
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className="tableCell">Doctor Specialization</TableCell>
        ...
        <TableBody>
          {data.map((item) => (
            <TableRow key={item._id}>
              ...
              <TableCell className="tableCell">{item.doctor_name}</TableCell>
              <TableCell className="tableCell">
